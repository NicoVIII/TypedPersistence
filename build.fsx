...
Target.create "Test" (fun _ ->
  exec "dotnet" @"run --project .\tests\TypedPersistence.UnitTests\TypedPersistence.UnitTests.fsproj" ".")
          ...
          { p.MSBuildParams with
              Properties =
                [ ("Version", nugetVersion)
                  ("PackageReleaseNotes", packageReleaseNotes) ] } }) "TypedPersistence.sln")
...
Target.create "Pack" (fun _ ->
  ...
  DotNet.pack (fun p ->
    { p with
        ...
        MSBuildParams =
          { p.MSBuildParams with
              Properties = properties } }) "TypedPersistence.sln")
